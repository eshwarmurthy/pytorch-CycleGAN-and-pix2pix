...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--netG", type=str, default="resnet_ultra_efficient", help="specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]")
        ...
        parser.add_argument("--crop_size", type=int, default=160, help="then crop to this size")
